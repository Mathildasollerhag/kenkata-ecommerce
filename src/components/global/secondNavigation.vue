    ...
    <div>
        <div class="container pt-4 pb-4">
            <div class="row">
                ...
                <div class="col-xl-4 d-flex"><div class="iconsextra class2 classmargin"><router-link to="/account"><span class="hover-green"><i class="far fa-user icon-size mr-1"></i> My account</span></router-link></div>
